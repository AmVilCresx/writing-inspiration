...
-- 初始数据：主数据（关联标签单独插入）
-- --------------------------------------------
INSERT INTO wi_entries (type, title, meaning, source, author, example, mood) VALUES
  ('成语', '画蛇添足', '画蛇时给蛇添上脚。比喻做了多余的事，反而不恰当。', '《战国策·齐策二》', NULL, '文章已经写得很完整了，再加一段总结反而显得啰嗦，有画蛇添足之嫌。', '讽刺'),
  ('成语', '破釜沉舟', '打破饭锅，凿沉渡船。比喻下定决心，不留退路。', '《史记·项羽本纪》', NULL, '面对这次竞聘，他破釜沉舟，辞去了原来的工作。', '豪迈'),
  ('名言', '世上只有一种英雄主义', '世界上只有一种真正的英雄主义，那就是在认清生活的真相后，依然热爱生活。', '《约翰·克利斯朵夫》', '罗曼·罗兰', '生活已经如此艰难，但他依然保持乐观——这正是罗曼·罗兰所说的英雄主义。', '励志'),
  ('名言', '不登高山不知天', '不登上高山，就不知道天有多高；不靠近深谷，就不知道地有多厚。比喻不亲身实践，就不知道事物的真实情况。', '《荀子·劝学》', NULL, '不登高山不知天，只有走出去实地考察，才能做出准确的判断。', '励志'),
  ('诗词', '天生我材必有用', '上天生下我，必定有需要我的地方；千金散尽，也还会再回来。表达自信豁达的人生态度。', '《将进酒》', '李白', '虽然这次创业失败了，但他始终相信天生我材必有用，收拾心情再出发。', '豪迈'),
  ('俗语', '冰冻三尺非一日之寒', '水结冰到三尺厚，不是一天的寒冷所能达到的。比喻一种情况的形成，是经过长时间的积累和酝酿的。', NULL, NULL, '他的懒惰并非一朝一夕，冰冻三尺非一日之寒，要改也不是一朝一夕的事。', '平淡'),
  ('成语', '朝三暮四', '原指玩弄手法欺骗人，后用来比喻常常变卦，反复无常。', '《庄子·齐物论》', NULL, '做事最忌朝三暮四，今天想做这个，明天想做那个，到头来一事无成。', '讽刺'),
  ('歇后语', '八仙过海', '八仙过海时各自施展自己的法术。比喻做事各有各的一套办法。', NULL, NULL, '这次比赛高手云集，可以说是八仙过海——各显神通。', '平淡'),
  ('名言', '不要问', '鼓励人们关注自身对社会的贡献。', '就职演说', '约翰·肯尼迪', '肯尼迪那句''不要问你的国家能为你做什么''，至今仍是责任意识的经典表达。', '励志'),
  ('成语', '滴水穿石', '水不停地滴，石头也能穿。比喻只要有恒心，不断努力，事情就一定能成功。', '宋代·罗大经《鹤林玉露》', NULL, '十年磨一剑，滴水穿石，他的努力终于得到了回报。', '励志');
